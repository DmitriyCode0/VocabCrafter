      ...
      <div className="flex items-center gap-3">
        <Button asChild variant="ghost" size="icon">
          <Link
            ...
            aria-label={messages.reviewDetail.backToReview}
          >
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              {quiz ? (
                <Badge variant="outline">{getActivityLabel(quiz.type)}</Badge>
              ) : null}
              {pct !== null ? (
                <Badge
                  variant={
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {feedbackList.map((fb) => {
              ...
              return (
                <div key={fb.id} className="space-y-1 rounded-lg border p-3">
                  <div className="flex items-center justify-between">
